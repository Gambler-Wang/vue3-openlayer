...
export const constantRoutes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      {
        path: "base-map",
        component: () => import("@/views/openlayer/base-map/index.vue"),
