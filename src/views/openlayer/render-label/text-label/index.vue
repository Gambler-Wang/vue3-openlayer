...
// 添加文字标注
const addTxtLabel = (isClean: boolean) =>{
  const coordinate = coordinateInput.value.split(',')
  const style = {
    color:'blue'
  }
  OlMapRef.value?.addTextLabel([{
    id: '1',
...
const addMassiveTxtLabel = (isClean: boolean)=>{
...
function getCoordinate () {
  ...
  for(let i=0; i<1000; i++) {
      ...
      dataArray.push({id:'id'+i,lng: randomLng,lat: randomLat,url: iconUrlInput.value || positionPic,name:textInput.value+ i});
  }
 return dataArray
}
...
<template>
  <div class="render-vector-container">
    <div class="left-box">
      ...
      <div class="line">
        <el-button type="primary" @click="addTxtLabel(false)">文字标注</el-button>
      </div>
      <div class="line">
        <el-button type="primary" @click="addTxtLabel(true)">文字标注,渲染前清空</el-button>
      </div>
      <div class="line">
        <el-button type="primary" @click="addMassiveTxtLabel(false)">海量文字标签</el-button>
      </div>
      <div class="line">
        <el-button type="primary" @click="addMassiveTxtLabel(true)">海量文字标签,渲染前清空</el-button>
      </div>
    </div>
    <div class="right-box">
      <OlMap ref="OlMapRef" />
